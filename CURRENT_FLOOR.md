...
- `form/form-stdlib/tests/kernel-length-band.fk` = 63 — the body reads its own emitted kernels back (statements, loops, bytes) before any GPU runs; `observe/kernel-length-run.fk` holds it to the ear's fifteen kernels and the Q8_0 family.
