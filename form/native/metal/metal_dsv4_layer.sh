...
// The comparator (assocwall, row 872). The oracle is fp64 and the GPU is f32 over a real-width reduction,
...
// ── GATE 23: hushfold (row 865) on the BODY's own numbers. RoPE is the identity at position 0, so a core
