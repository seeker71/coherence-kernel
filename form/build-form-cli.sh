...
FORM_CLI_SELFHOST_SRCS=(
    ...
    "$S/current-branch-landing.fk" "$S/form-cli-inquiry.fk" "$S/native-model-native-hierarchy.fk" "$S/form-cli.fk" "$S/form-cli-gguf-cell.fk"
    "$S/form-cli-repl.fk"
)
