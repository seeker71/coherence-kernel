...
do
    ...
    do
        ...
        labels=$(printf '%s' "$completion64" | { base64 -d 2>/dev/null || base64 -D; } |
...
# Use the native program-image selector for these canonical Form cells.  The
# source-forcing path bypasses the fresh .fkb cache and repeatedly reparses this large
