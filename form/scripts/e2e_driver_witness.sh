...
# per-stage receipt. Two direct fkwu Form runs: (1) the real community-page prompt through template +
...
if [[ ! -x ./fkwu || runtime/fkwu-uni.c -nt ./fkwu ]]; then
    echo "building runtime fkwu (direct Form door)..." >&2
...
receipt = {
  ...
  "runtime": "fkwu direct Form program-image invocation",
