...
proves and the source door runs. Genuinely high-grammar (declared attributes + dispatched function-values),
...
| sensor | organ file | declared attributes | feature delegated to | fusion | the source door witness | verdict |
|---|---|---|---|---|---|---|
