...
| [Concept source audit](native-concept-source-audit.md) | Form owns canonical cells, stable IDs, aliases, provenance, manifest verification and exact held-byte hashing; portable and explicitly selected ARM64 policies agree |
