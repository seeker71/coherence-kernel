...
- [x] **Speech current status ledger added.** `learn/speech-current-status-ledger.fk` composes the metrics report,
      ...
      `3/3` native), native neural weights now report `19`, native Sema voice organs remain `6`, and C seed growth
      remains `0`.
...
- [x] **Speech neural pair coverage added.** `learn/speech-neural-pair-coverage.fk` makes the pair-training
      boundary executable (`32767`): locale `A=>neural=>B` coverage is now `19/55` broad ready pairs and `38/110`
      directed routes, with `19` neural epochs and `19` native neural parameters. The separate Form-native seeded
...
- [x] **Speech pair training next action added.** `learn/speech-pair-training-next-action.fk` now chooses the next
      executable neural movement (`32767`): choose `next-native-neural-pair-window-0020` over `es<->fr`, route
      `train-native-neural-pair-window`, keep Form-native pair windows `8 -> 8`, move neural pair windows `19 -> 20`,
...
- [x] **Speech authority learning priority added.** `learn/speech-authority-learning-priority.fk` makes the
      authority gap executable (`32767`): trained pair coverage is `19/55`, and `next-native-neural-pair-window-0020`
      over `es<->fr` stays available as the background coverage lane, but the measured open ASR gap `100` and
...
- [x] **Speech native neural pair window 0002 added.** `learn/speech-native-neural-pair-window-0002.fk` trains
...
- [x] **Speech native neural pair window 0004 added.** `learn/speech-native-neural-pair-window-0004.fk` trains
      the fourth native neural micro-pair over `en<->zh` (`32767`): neural pair coverage moves to `4` unordered
      pairs and `8` directed routes, with `4` native neural parameters, `4` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0005` over `en<->ar`.
- [x] **Speech native neural pair window 0005 added.** `learn/speech-native-neural-pair-window-0005.fk` trains
      the fifth native neural micro-pair over `en<->ar` (`32767`): neural pair coverage moves to `5` unordered
      pairs and `10` directed routes, with `5` native neural parameters, `5` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0006` over `en<->la`.
- [x] **Speech native neural pair window 0006 added.** `learn/speech-native-neural-pair-window-0006.fk` trains
...
- [x] **Speech native neural pair window 0008 added.** `learn/speech-native-neural-pair-window-0008.fk` trains
      the eighth native neural micro-pair over `en<->es` (`32767`): neural pair coverage moves to `8` unordered
      pairs and `16` directed routes, with `8` native neural parameters, `8` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0009` over `en<->sa`.
- [x] **Speech native neural pair window 0009 added.** `learn/speech-native-neural-pair-window-0009.fk` trains
      the ninth native neural micro-pair over `en<->sa` (`32767`): neural pair coverage moves to `9` unordered
      pairs and `18` directed routes, with `9` native neural parameters, `9` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0010` over `zh<->ar`.
- [x] **Speech native neural pair window 0010 added.** `learn/speech-native-neural-pair-window-0010.fk` trains
      the tenth native neural micro-pair over `zh<->ar` (`32767`): neural pair coverage moves to `10` unordered
      pairs and `20` directed routes, with `10` native neural parameters, `10` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0011` over `sa<->la`.
- [x] **Speech native neural pair window 0011 added.** `learn/speech-native-neural-pair-window-0011.fk` trains
      the eleventh native neural micro-pair over `sa<->la` (`32767`): neural pair coverage moves to `11` unordered
      pairs and `22` directed routes, with `11` native neural parameters, `11` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0012` over `zh<->sa`.
- [x] **Speech native neural pair window 0012 added.** `learn/speech-native-neural-pair-window-0012.fk` trains
      the twelfth native neural micro-pair over `zh<->sa` (`32767`): neural pair coverage moves to `12` unordered
      pairs and `24` directed routes, with `12` native neural parameters, `12` epochs, and neural rate `0 -> 100`.
      The next selected movement is `next-native-neural-pair-window-0013` over `ar<->sa`.
- [x] **Speech native neural pair window 0013 added.** `learn/speech-native-neural-pair-window-0013.fk` trains
      the thirteenth native neural micro-pair over `ar<->sa` (`32767`): neural pair coverage moves to `13`
      unordered pairs and `26` directed routes, with `13` native neural parameters, `13` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0014` over `zh<->la`.
- [x] **Speech native neural pair window 0014 added.** `learn/speech-native-neural-pair-window-0014.fk` trains
      the fourteenth native neural micro-pair over `zh<->la` (`32767`): neural pair coverage moves to `14`
      unordered pairs and `28` directed routes, with `14` native neural parameters, `14` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0015` over `ar<->la`.
- [x] **Speech native neural pair window 0015 added.** `learn/speech-native-neural-pair-window-0015.fk` trains
      the fifteenth native neural micro-pair over `ar<->la` (`32767`): neural pair coverage moves to `15`
      unordered pairs and `30` directed routes, with `15` native neural parameters, `15` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0016` over `de<->es`.
- [x] **Speech native neural pair window 0016 added.** `learn/speech-native-neural-pair-window-0016.fk` trains
      the sixteenth native neural micro-pair over `de<->es` (`32767`): neural pair coverage moves to `16`
      unordered pairs and `32` directed routes, with `16` native neural parameters, `16` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0017` over `de<->fr`.
- [x] **Speech native neural pair window 0017 added.** `learn/speech-native-neural-pair-window-0017.fk` trains
      the seventeenth native neural micro-pair over `de<->fr` (`32767`): neural pair coverage moves to `17`
      unordered pairs and `34` directed routes, with `17` native neural parameters, `17` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0018` over `de<->id`.
- [x] **Speech native neural pair window 0018 added.** `learn/speech-native-neural-pair-window-0018.fk` trains
      the eighteenth native neural micro-pair over `de<->id` (`32767`): neural pair coverage moves to `18`
      unordered pairs and `36` directed routes, with `18` native neural parameters, `18` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0019` over `de<->pt-br`.
- [x] **Speech native neural pair window 0019 added.** `learn/speech-native-neural-pair-window-0019.fk` trains
      the nineteenth native neural micro-pair over `de<->pt-br` (`32767`): neural pair coverage moves to `19`
      unordered pairs and `38` directed routes, with `19` native neural parameters, `19` epochs, and neural rate
      `0 -> 100`. The next selected movement is `next-native-neural-pair-window-0020` over `es<->fr`.
