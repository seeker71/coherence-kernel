...
Run the Form recipe directly: `fkwu proof/four-way-ground.fk`.
`host-exec` is an observable host port
...
host-exec'd values, not the literal. The sibling comparison is optional
corroboration and never a runtime dependency. Full historical evidence:
`receipts/2026-06-29-kernel-self-proves-four-way.md`.
