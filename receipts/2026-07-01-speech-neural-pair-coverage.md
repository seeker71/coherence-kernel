...
```text
trained unordered neural pairs: 7
trained directed neural pair routes: 14
neural training epochs: 7
native neural parameters: 7
broad ready pair space: 55 unordered / 110 directed
neural coverage: 1272 basis points
```
...
```text
pairs: en<->fr, en<->pt-br, en<->id, en<->zh, en<->ar, en<->la, en<->de
