...
```text
trained unordered neural pairs: 14
trained directed neural pair routes: 28
neural training epochs: 14
native neural parameters: 14
broad ready pair space: 55 unordered / 110 directed
neural coverage: 2545 basis points
```
