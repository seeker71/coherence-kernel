...
```text
trained unordered neural pairs: 15
trained directed neural pair routes: 30
neural training epochs: 15
native neural parameters: 15
broad ready pair space: 55 unordered / 110 directed
neural coverage: 2727 basis points
```
