...
```text
trained unordered neural pairs: 16
trained directed neural pair routes: 32
neural training epochs: 16
native neural parameters: 16
broad ready pair space: 55 unordered / 110 directed
neural coverage: 2909 basis points
```
