...
```text
trained unordered neural pairs: 10
trained directed neural pair routes: 20
neural training epochs: 10
native neural parameters: 10
broad ready pair space: 55 unordered / 110 directed
neural coverage: 1818 basis points
```
