...
```text
trained unordered neural pairs: 18
trained directed neural pair routes: 36
neural training epochs: 18
native neural parameters: 18
broad ready pair space: 55 unordered / 110 directed
neural coverage: 3272 basis points
```
