...
```text
trained unordered neural pairs: 17
trained directed neural pair routes: 34
neural training epochs: 17
native neural parameters: 17
broad ready pair space: 55 unordered / 110 directed
neural coverage: 3090 basis points
```
