...
- **The router asymmetry is load-bearing (gate 9).** The kernel's weights match the UNbiased
  ...
  fires, the unbiased prob sets HOW MUCH. Flip it and the fold moves. Named as corpus row 867,
  `steerdrop`.
...
| gate | result |
|---|---|
| corpus band (both arms: go + fkwu) | **8191** (row 867 `steerdrop`; pins 256→257, 860→861, field-code 2562562860→2572572861) |
...
how much?* → **`steerdrop`** (corpus row 867). 0-hit fresh across learn/, receipts/, docs/,
