...
half of the layer, and the 42.6% of the file this body still cannot read (row 853 `mutewide`).
...
its radius declared. Cites: row 852 `apposition`, row 853 `mutewide`, row 854 `ghostrank`;
