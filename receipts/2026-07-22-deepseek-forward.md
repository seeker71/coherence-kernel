...
`form/form-stdlib/tests/dsv4-forward-oracle.py`), corpus row 865 (`hushfold`).
...
Corpus band from repo root → **8191** (row 865 added; count/field-code pins updated 254→255,
