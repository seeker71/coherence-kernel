...
wrong. The frontier word `wraithcarry` (corpus row 870) is that lesson: a datum you can read and
...
**The frontier question.** Named above and landed as **corpus row 870, `wraithcarry`** — *what one
