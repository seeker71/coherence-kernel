...
- `form/form-stdlib/runtime-program-image-fkb-symbol-walk.fk` is Layer 9h6,
  ...
  receipt, and computed trace so typed string values and every reachable
  refusal/timeout/error reason stay observable. It
