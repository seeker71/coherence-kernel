...
corpus row 855 `paritylock`. No kernel built; CPU carver only.
...
| corpus band | 8191 | **8191** (after row 855, pins re-probed) |
...
**Frontier question, landed as corpus row 855** (`learn/homecoming-distillation-corpus.fk`):
