...
Meaning: the next honest move is to run the fifteenth native neural micro-pair
window and keep capturing consentful audio. The planned neural count moves
`14 -> 15`; full open ASR/TTS authority still waits for open receipts.
