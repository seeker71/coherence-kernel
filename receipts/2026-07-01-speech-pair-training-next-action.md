...
Meaning: the next honest move is to run the eighth native neural micro-pair
window and keep capturing consentful audio. The planned neural count moves
`7 -> 8`; full open ASR/TTS authority still waits for open receipts.
