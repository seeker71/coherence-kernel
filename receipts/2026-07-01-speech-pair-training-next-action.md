...
Meaning: the next honest move is to run the seventeenth native neural micro-pair
window and keep capturing consentful audio. The planned neural count moves
`16 -> 17`; full open ASR/TTS authority still waits for open receipts.
