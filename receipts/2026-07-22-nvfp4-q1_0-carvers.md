...
geometry. An unexercised declaration is unfalsifiable. That became corpus row 850, `gapmete`.
...
Landed as `(hdc-row 850 …)` in `learn/homecoming-distillation-corpus.fk`; corpus band **4095**; field
