...
**Corpus:** row 1039 `carrygap`, 1023 `primshadow`
...
> **frontier questions**
> what names an unused import that carries the absences of what it names? → **carrygap** (row 1039)
> what names a definition that never runs because the kernel owns its name? → **primshadow** (row 1040)
